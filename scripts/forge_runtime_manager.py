...
def build_maintenance_html():
    ...
    if "IIB_SKIP_OPTIONAL_DEPS=1" in bat_text:
        lines.append(maintenance_badge("Infinite Image Browsing", "ok", "Optional dependency installs are skipped."))
...
def on_ui_settings():
    ...
    opts.add_option("forge_opt_emergency_instant_mb", shared.OptionInfo(
        ...
        gr.Slider, {"minimum": 50, "maximum": 300, "st"""
Forge Runtime Manager V1 - safety-first runtime monitor.
